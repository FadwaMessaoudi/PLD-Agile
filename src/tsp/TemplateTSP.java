...
public abstract class TemplateTSP implements TSP {
	...
	public void searchSolution(int limitTime, int nodesNbr, int[][] costs, int[] durations){
		...
		meilleureSolution = new Integer[nodesNbr];
		ArrayList<Integer> nonVus = new ArrayList<Integer>();
		for (int i=1; i<nodesNbr; i++) nonVus.add(i);
		ArrayList<Integer> vus = new ArrayList<Integer>(nodesNbr);
		vus.add(0); // le premier sommet visite est 0
		branchAndBound(0, nonVus, vus, 0, costs, durations, System.currentTimeMillis(), limitTime);
	}
