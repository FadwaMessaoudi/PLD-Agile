...
public interface TSP {
	 ...
	 * @param nodesNbr : nombre de sommets du graphe
	 * @param costs : costs[i][j] = duree pour aller de i a j, avec 0 <= i < nbSommets et 0 <= j < nbSommets
	 * @param durations : durations[i] = duree pour visiter le sommet i, avec 0 <= i < nbSommets
	 */
	public void searchSolution(int limitTime, int nodesNbr, int[][] costs, int[] durations);
